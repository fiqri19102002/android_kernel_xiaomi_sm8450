	...
	struct goodix_ts_board_data *board_data)
{
	...
	gpio_a = gpio_get_value(GOODIX_DISP_ID_DET);
	gpio_b = gpio_get_value(GOODIX_DISP_ID1_DET);
...
static int __init goodix_ts_core_init(void)
{
	...
	gpio_direction_input(GOODIX_DISP_ID_DET);
	gpio_a = gpio_get_value(GOODIX_DISP_ID_DET);
	gpio_direction_input(GOODIX_DISP_ID1_DET);
	gpio_b = gpio_get_value(GOODIX_DISP_ID1_DET);
